...
export async function transformToDraftListing(
  ...
  return {
    ...
    hasLoan: parsed.hasLoan ?? false,
    loanAmount: parsed.loanAmount ?? null,
    shortDescription: parsed.shortDescription ?? "",
    features: parsed.features ?? [],
    naverUrl: source.url ?? parsed.naverMeLink,
...
export function mergeParsedIntoExisting(
  ...
  return {
    ...
    hasLoan: parsed.hasLoan ?? existing.hasLoan,
    loanAmount: parsed.hasLoan !== undefined ? (parsed.loanAmount ?? null) : existing.loanAmount,
    ...
    naverUrl: source.url ?? parsed.naverMeLink ?? existing.naverUrl,
