...
import { LISTING_SORT_OPTIONS, parseListingSortKey } from "../lib/listingSort";
...
/**
 * /listings 정렬 드롭다운. 선택 즉시(제출 버튼 없이) URL의 sort 쿼리를 바꿔
 * 새로고침해도 유지되고 링크로 공유할 수 있게 합니다. 다른 필터(propertyType 등)는
 * 현재 URL에 있는 값을 그대로 보존합니다.
 */
